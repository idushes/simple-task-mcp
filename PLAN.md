...
**Версия**: 0.1.1  
**Статус**: В разработке  
**Завершенные этапы**: 11 из 12  
**Текущий этап**: Этап 2.1 - Список пользователей
...
**Файлы**: `tools/list_users.go`, `tools/register_list_users.go`, `database/migrations/006_add_user_description.sql`
</details>
